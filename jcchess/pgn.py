...
class Psn:
    ...
    #
    #
    # Example moves we can expect in a file created by jcchess
    #
    ...
    #   P*5f
    #
    # Other formats we can expect in files not created by jcchess
    #   P2f
    #   Px4d
    #   +Rx6a
    #   xS
        ...
        for l in lm:
            ...
            if piece != "":
                ...
                if self.validate_square(source_square):
                    valid = True
                    # convert standard notation for square into jcchess
    ...
    def load_game_pgn(self, fname):
        ...
        # Code to test all games in a file to see if jcchess will load them
        """
        ok_cnt = 0
        error_cnt = 0
